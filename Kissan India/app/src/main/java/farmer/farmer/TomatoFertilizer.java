...
public class TomatoFertilizer extends AppCompatActivity {
        ...
        switch (item.getItemId()) {
            ...
            default:
                ...
                if (id==R.id.action_settings) {
                    Intent intent = new Intent(TomatoFertilizer.this, SettingsActivity.class);
                    ...
                    Intent intent = new Intent(TomatoFertilizer.this, Action_Feedback.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.push_down_in, R.anim.push_down_out);
                    return true;
                }
